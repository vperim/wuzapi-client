...
/// <summary>
/// Configuration options for WuzAPI admin client.
/// </summary>
public sealed class WuzApiAdminOptions
{
    /// <summary>
    /// Configuration section name in appsettings.json.
    /// </summary>
    public const string SectionName = "WuzApiAdmin";
    ...
    /// <summary>
    /// Gets or sets the admin token for authentication.
    /// This token is sent in the "Authorization" header for admin API requests.
    /// </summary>
    ...
    public void Validate()
    {
        ...
        if (string.IsNullOrWhiteSpace(this.AdminToken))
        {
            throw new WuzApiConfigurationException("AdminToken is required.");
        }
